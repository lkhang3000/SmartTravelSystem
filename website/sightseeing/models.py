...
class Trip(models.Model):
    ...
    budget = models.IntegerField(null=True, blank=True)  # Budget in VND
    travelers = models.IntegerField(default=1, null=True, blank=True)
    price_per_person = models.DecimalField(max_digits=10, decimal_places=2, null=True, blank=True)  # Price per person in VND
